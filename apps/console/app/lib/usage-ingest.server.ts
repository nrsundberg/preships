import { executeQuery, type D1DatabaseLike } from "./db.server";
...
export async function ingestUsageForOrg(params: {
  ...
  if (modelId) {
    ...
    await executeQuery(
      ...
      [crypto.randomUUID(), params.organizationId, usageDate, nowIso, nowIso],
    );
    ...
    await executeQuery(
      ...
      [params.organizationId, usageDate, nowIso, params.organizationId, usageDate],
    );
  }
