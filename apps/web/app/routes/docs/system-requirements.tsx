export default function SystemRequirements() {
  const models = [
    ...
    { name: "qwen2.5-coder:7b", params: "7B", ram: "8 GB", best: "Default — good balance of speed and quality" },
    { name: "llama3.2:11b-vision", params: "11B", ram: "12 GB", best: "Visual checks — screenshot analysis" },
    { name: "qwen2.5-coder:14b", params: "14B", ram: "16 GB", best: "Complex interaction flow reasoning" },
  ...
  return (
    <>
      ...
      <p className="mt-3 text-text-content">
        Preships runs on macOS, Linux, and Windows. Deterministic checks work on
        any machine with Node 20+. No GPU or model runtime needed for those.
      </p>
      ...
      <div className="mt-4 rounded-lg border border-border border-l-accent border-l-[3px] bg-[#131a27] px-3 py-2.5 text-sm text-text-content">
        Apple Silicon Macs share system RAM with the GPU, so a 16 GB M-series
        MacBook can comfortably run 7B–14B models. On discrete GPU systems, VRAM
        is what matters — a 12 GB NVIDIA card handles up to 11B well.
      </div>
      ...
      <p className="mt-3 text-text-content">
        Detects your hardware, checks for Ollama and Playwright, and recommends
        which model to use based on available RAM.
      </p>
      ...
      <p className="mt-3 text-sm text-text-muted">
        Deterministic checks still run locally. Only reasoning/visual checks
        route through the cloud.
      </p>
    </>
  );
}
