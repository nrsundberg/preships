  ...
  return (
    <>
      ...
      <p className="mt-3 text-text-content">
        Use <code className="rounded bg-code-bg px-1.5 py-0.5 text-sm">preships chat</code> to
        interactively refine your repo's QA goals, plan docs, and configuration via conversation
...
preships chat --endpoint http://other-host:11434`}</code>
        ...
        <table className="w-full border-collapse text-sm">
          ...
          <tbody className="text-text-content">
            ...
            <tr className="border-b border-border">
              ...
              <td className="px-3 py-2">
                Append a new goal to <code className="text-xs">.preships/plan.md</code>.
              </td>
            </tr>
            <tr className="border-b border-border">
              <td className="px-3 py-2">
      ...
      <p className="mt-3 text-text-content">
        The chat session loads your repo's plan doc and config as system context, then sends your
        messages to the configured model (local Ollama by default). Conversations are logged to{" "}
        <code className="rounded bg-code-bg px-1 py-0.5 text-xs">.preships/chat-log.md</code> so
        coding agents can reference what was discussed.
      </p>
    </>
  );
}
